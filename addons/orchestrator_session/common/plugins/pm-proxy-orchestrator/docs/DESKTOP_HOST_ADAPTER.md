...
Version `0.4.8` includes an opt-in desktop host adapter for one exact root task.
...
task. First install the complete `0.4.8` plugin, recreate the runtime pin for the
